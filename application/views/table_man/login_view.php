...
<div class="row">
 ...
 <div class="col-md-6">
    <form method="POST" action="<?php echo base_url();?>index.php/table_man/login/loginform">
    ...
    <table border="0" align="center" class="table" style="border:1px solid #333;">
        ...
        <td colspan="2"><div align="center"><a href="<?php echo base_url();?>index.php/table_man/table_man/index" >New User</a></div></td>
    </table>
	</div>
